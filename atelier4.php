...
<div class="col-12 zone_retour">
    ...
    <div class="container-fluid container8">
        ...
        <h3 class="ordre">Après avoir obtenu votre score, graduez
    ...
    <div class="container-fluid slidecontainer">
                    <span class="number" id="demo8"></span>
                    <br>

                    <form action="curseurconnect.php" method="post">
    <input type="range" min="0" max="100" class="slider" step="25" id="myRange8" name="curseuri" onclick="getValue8()">

    </form>
    <div class="col-md-1 hautparleur">0%</div>
   <div class="col-md-1 drapeau">100%</div>
    ...
    <script type="text/javascript" src="js/slide8.js"></script>
</body>
