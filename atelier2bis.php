...
<body>
    ...
    <section class="container-fluid ctnr_at2">
        <div class="row">
            <div class="boussoletexte">
                <div class="col-9 zone_instruction_at2">
                    <div class="instruction_at2">Graduer ces affirmations en faisant glisser le curseur</div>
                </div>
                <div class="col-3 zone_boussole_at2bis">
            ...
            <div class="col-12 zone_slider2_at2">
                ...
                <div class="col-12 multislider_at2">
                    ...
                    <div class="container-fluid slidecontainer">
                        ...
                        <div class="col-md-1 hautparleur"><svg class="speaker" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 13.32 8.57">
                                <defs>
                                    <style>
                                        .cls-100 {
                                            fill: #4cbfdd;
                                ...
                                <g id="Calque_2" data-name="Calque 2">
                                    <g id="Calque_1-2" data-name="Calque 1">
                                        ...
                                        <path class="cls-100"
                                            d="M12.64.19c-.05,0-.14,0-.18.06-.87.62-1.74,1.25-2.62,1.86-.05.05-.16,0-.25,0s.05-.16.12-.21L12.31.07c.1-.07.19-.15.33.12" />
                                        <path class="cls-100"
                                            d="M13.32,3.32c-.08.06-.11.13-.21.13-.51,0-1,0-1.54,0v.09H10a.3.3,0,0,1-.16,0,.11.11,0,0,1-.09-.07.18.18,0,0,1,.09-.14.3.3,0,0,1,.16,0c1,0,2,0,3.07,0a.42.42,0,0,1,.21.09" />
                                        <path class="cls-100"
                                            d="M12.05,6.76a.61.61,0,0,1-.19,0,1.48,1.48,0,0,1-.27-.19c-.66-.57-1.35-1.12-2-1.67a.19.19,0,0,1-.13-.1s0-.08,0-.14a.25.25,0,0,1,.16,0,3.1,3.1,0,0,1,.34.27c.65.54,1.33,1.08,2,1.61l.16.18a.24.24,0,0,0,0,.07" />
                                    </g>
                                </g>
                            </svg> </div>
<form action="curseurconnect.php" <?php echo $_POST['$curseurb']?>   id="form1" method="post" >
<input type="range" min="0" max="100" class="slider" data="curseurb" step="25" id="curseurb" name="curseurb" onclick="getValue1()">
</form>
                        <div class="col-md-1 drapeau"><svg class="drap" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 15.06 8.51">
                                <defs>
                                    <style>
                                        .cls-1 {
                                            fill: #4cbfdd;
...
<form action="curseurconnect.php" <?php echo $_POST['$curseurc']?>   id="form" method="post" >
<input type="range" min="0" max="100" class="slider" data="curseurc" step="25" id="curseurc" name="curseurc" onclick="getValue2()">
</form>
                        <div class="col-md-1 drapeau"><svg class="drap" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 15.06 8.51">
                                <defs>
...
<form action="curseurconnect.php" <?php echo $_POST['$curseurd']?>   id="form" method="post" >
<input type="range" min="0" max="100" class="slider" data="curseurd" step="25" id="curseurd" name="curseurd" onclick="getValue3()">
</form>
                        <div class="col-md-1 drapeau"><svg class="drap" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 15.06 8.51">
                                <defs>
...
<form action="curseurconnect.php" <?php echo $_POST['$curseure']?>   id="form" method="post" >
<input type="range" min="0" max="100" class="slider" data="curseure" step="25" id="curseure" name="curseure" onclick="getValue4()">
</form>
                        <div class="col-md-1 drapeau"><svg class="drap" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 15.06 8.51">
                                <defs>
            ...
            <div class="col-3 zone_button_next">
                <a href="atelier3.php">
                    <form action="atelier3.php" method="post">

                        <button type="submit" name="submitcurseur" value="Envoyé"><object ...>
                                ...
                                <svg class="button_next_at2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4.75 4.75">
                                    ...
                                    <g id="Calque_2" data-name="Calque 2">
                                        <g id="Calque_1-2" data-name="Calque 1">
                                            <path class="cls-1"
                                                d="M3.9,2.38A1.53,1.53,0,1,1,2.38.85,1.52,1.52,0,0,1,3.9,2.38Z" />
